...
export default function Home() {
  return (
    <div className="relative overflow-hidden">
      ...
      />
      <div
        className="pointer-events-none absolute inset-x-0 top-0 h-[600px] glow"
        aria-hidden
      />
      ...
      <section className="relative mx-auto max-w-7xl px-4 pb-16 pt-20 sm:px-6 sm:pt-28">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div className="min-w-0 animate-fade-up">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-fg-muted">
              Fin is a fast, opinionated CLI for running local-development
              Docker containers. Declare a few{" "}
              <code className="font-mono text-accent">FIN_*</code> variables in
              your <code className="font-mono text-accent">.env</code>, run{" "}
              <code className="font-mono text-accent">fin up</code>, and get a
              routing proxy, shared databases, and your app — all on friendly{" "}
              <code className="font-mono text-accent">*.localhost</code>{" "}
              hostnames.
            </p>
        ...
        <div className="mx-auto mt-16 max-w-3xl">
          <p className="mb-2 text-center text-sm text-fg-faint">
            Install in one line — a prebuilt, standalone binary. No Python
      ...
      <section className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6">
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-fg-muted">
            Point Fin at a project, declare what it needs, and let it
            orchestrate the proxy, assets, and your app container.
          </p>
        </div>
        <div className="grid gap-6 lg:grid-cols-2">
          <div>
            <div className="mb-3 flex items-center gap-2 text-sm text-fg-faint">
              <span className="rounded bg-panel px-2 py-0.5 font-mono text-xs text-accent">
                1
              </span>
...
fin ps`}
      ...
      <section className="relative mx-auto max-w-7xl px-4 pb-24 pt-8 sm:px-6">
        <div className="overflow-hidden rounded-card border border-border bg-gradient-to-br from-panel to-bg-soft p-10 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-fg-muted">
            Every app type and service is a <em>plug</em> — a small declarative
            class that describes containers and contributes commands. Catalog
            plugs cover Laravel, Django, MySQL, PostgreSQL, Redis and MinIO.
            Write your own in a few lines of Python.
          </p>
